...
include("it61_file_obj.php");

$it61FileObj = new it61FileObj();

switch($_POST['action']){
	
	case "it61Data":
		
		$directory="C:/wamp/www/OLIC/it61_data/";
			$arch_directory="C:/wamp/www/OLIC/it61_archive/";
			...
			if ($checkEmpty == "Empty"){
				...
				$it61FileObj->clearTblIt61Invoice();
						...
						if($file_ext == "901"){
							...
							if (($handle = fopen($csv_file, "r")) !== FALSE) {
								...
								while (($data = fgetcsv($handle, 10000000, "|")) !== FALSE) {
									...
									$it61FileObj->it61Data($col1,$col2,$col3,$col4,$col5,$col6,$col7,$col8,$col9,$col10,$col11,$col12,$col13,$col14,$col15,$col16,$col17,$col18,$col19,$col20,$col21,$col22,$col23,$col24,$col25,$col26,$col27,$col28,$col29,$col30,$col31,$col32,$col33,$col34,$col35,$col36,$col37,$col38,$col39,$col40);
								}	
								if($loaded = $it61FileObj->displayLoadedRec()){
									echo "
	...
	case "mmsDataRemvSpace":
		$it61FileObj->mmsDataRemvSpace();
	exit();
	break;	
	
	case "oracleData":
		$it61FileObj->oracleData();
	exit();
	
	case "remvLoadedInv":
		$it61FileObj->remvLoadedInv();
	exit();
	break;	
	
	case "updFileName":
		$it61FileObj->updFileName();
	exit();
	break;	
	
	case "createTxtFile":
	
		$arrFileName = $it61FileObj->viewFileName();
		
		foreach($arrFileName as $valFileName){
			
			$fileName = $valFileName['Col040'];
			
			$arrFileCont = $it61FileObj->viewIt61($fileName);
	...
	<head>
        ...
        <script type="text/javascript">
			function process()
			{
				...
				$.ajax
				({
					url: 'it61_file_mydel.php',
					type: 'POST',
					data: 'action=it61Data',
					beforeSend: function()
					{
        ...
        <body>
            ...
            <center>
            	<div id="activity_pane" style="height: 100vh;">
                    ...
                    <table border="0">
                    	<th colspan="2">
							<h3 align="center"><font style="font-family:Lucida Handwriting"> 901 - IT61 (Textfiles) </font></h3>
                        </th>
                        <tr>
                            <td colspan="2">
                                <center>
