...
class h01FileObj extends commonObj {
	...
	function updFileName($orgId) {
        ...
        $sqlPj="
        update tbl_h01_invoice set filename = 'PJ{$curDate}_{$curTime}.H01' where type = 'STS'
        and strshrt in 
        (
        ...
        $sqlPg="
        update tbl_h01_invoice set filename = 'PG{$curDate}_{$curTime}.H01' where type = 'STS' 
        and strshrt in 
        (
        ...
        $sqlPc="
        update tbl_h01_invoice set filename = 'PC{$curDate}_{$curTime}.H01' where type = 'STS'
        and strshrt in 
        (
        ...
        $sqlDi="
        update tbl_h01_invoice set filename = 'DI{$curDate}_{$curTime}.H01' where type = 'STS'
        and strshrt in 
        (
        ...
        $sqlFl="
        update tbl_h01_invoice set filename = 'FL{$curDate}_{$curTime}.H01' where type = 'STS'
        and strshrt in 
        (
