...
switch($_POST['action']){
	...
	case "j01Data":
        ...
        if($_POST['orgId'] == '87'){
            $directory="C:/wamp/www/OLIC/imported_file/j01/j01_pj_data/";  
            $arch_directory="C:/wamp/www/OLIC/imported_file/j01/j01_pj_archive/"; 
            $orgName = "PJ";   
        }else if($_POST['orgId'] == '85'){
            $directory="C:/wamp/www/OLIC/imported_file/j01/j01_pg_data/";  
            $arch_directory="C:/wamp/www/OLIC/imported_file/j01/j01_pg_archive/";  
            $orgName = "PG";
        }else if($_POST['orgId'] == '133'){
            $directory="C:/wamp/www/OLIC/imported_file/j01/j01_sbc_data/";  
            $arch_directory="C:/wamp/www/OLIC/imported_file/j01/j01_sbc_archive/";  
            $orgName = "PC";
        }else if($_POST['orgId'] == '153'){
            $directory="C:/wamp/www/OLIC/imported_file/j01/j01_di_data/";  
            $arch_directory="C:/wamp/www/OLIC/imported_file/j01/j01_di_archive/";
            $orgName = "DI";  
        }else if($_POST['orgId'] == '113'){
            $directory="C:/wamp/www/OLIC/imported_file/j01/j01_fl_data/";  
            $arch_directory="C:/wamp/www/OLIC/imported_file/j01/j01_fl_archive/";
            $orgName = "FL";  
        }else{
            $directory="";  
            $arch_directory="";
			...
			if ($checkEmpty == "Empty"){
				...
				foreach(glob($directory.'*.J01*') as $v){
					unlink($v);
				}
				foreach(glob($directory.'*.J01*') as $v){
					unlink($v);
	...
	case "oracleData":
		$j01FileObj->oracleData($_POST['orgId']);
	exit();
	...
	case "updFileName":
		$j01FileObj->updFileName($_POST['orgId']);
	exit();
	break;	
        ...
        <script type="text/javascript">
			function process()
			{
				...
				({
					url: 'j01_file.php',
					type: 'POST',
					data: 'action=j01Data&orgId='+orgId,
					beforeSend: function()
					{
            ...
            <div id="activity_pane" align="center">
                ...
                <table border="0">
                    ...
                    <tr>
                        ...
                        <td><? $j01FileObj->DropDownMenu($arrOrgId,'cmbOrgId','','class="selectBox"'); ?></td>
                    </tr>
                    <tr>
                        <td colspan="3">
                            <center>
