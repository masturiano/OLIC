...
switch($_POST['action']){
	...
	case "createTxtFile":
		...
		foreach($arrFileName as $valFileName){
			...
			$arrFileCont = $stsObj->viewSts($fileName);
...
$arrOrgId = array('0'=>"Select Company",'89'=>"Clark",'91'=>"Subic");
?>
			...
			function process()
			{
				...
				({
					...
					success: function(data1){
						$().toastmessage('showToast', {
							text: 'Copy 401 (STS Duty Free) data success!',
							sticky: false,
							position: 'middle-center',
							type: 'success',
							closeText: '',
            ...
            <div id="activity_pane" align="center">
                ...
                <table border="0">
                        ...
                        <tr>
                            ...
                            <td><? $stsObj->DropDownMenu($arrOrgId,'cmbOrgId','','class="selectBox ui-widget-content ui-corner-all"'); ?></td>
                        </tr>  
                        <tr>
                            <td colspan="3">
                                <center>
                                    <br />
                                    <button class="btn btn-success" id="process" onClick="process();" value="Analyze">  Process  </button>
                                </center>
                            </td>
                        </tr>
                    </table>
