...
class sidFileObj extends commonObj {
	...
	function sidData($col1,$col2,$col3,$col4,$col5,$col6,$col7,$col8,$col9,$col10,$col11,$col12,$col13,$col14,$col15,$col16,$col17,$col18,$col19,$col20,$col21,$col22,$col23,$col24,$col25,$col26,$col27,$col28,$col29,$col30,$col31,$col32,$col33,$col34,$col35,$col36,$col37,$col38,$col39,$col40) {
	...
	function sumMmsData($reqId) {
		...
		(select sum(cast(Col013 as float)) as uniqAmt,cast(Col001 as nvarchar)+'-'+cast(Col004 as nvarchar) as uniqInv from tbl_sid_invoice group by cast(Col001 as nvarchar)+'-'+cast(Col004 as nvarchar)) as tbl_sid_invoice
		";
	...
	function countMmsInvData($reqId) {
		...
		(select cast(Col001 as nvarchar)+'-'+cast(Col004 as nvarchar) as uniqInv from tbl_sid_invoice group by cast(Col001 as nvarchar)+'-'+cast(Col004 as nvarchar)) as tbl_sid_invoice
		";
	...
	function sumOracleData($reqId) {
		$sql="
		select sum(INVOICE_AMOUNT) AS INVOICE_AMOUNT from  tbl_ap_invoices_all_sid_amount
		";
	...
	function countOracleInvData($reqId) {
		...
		(select cast(INVOICE_NUM as nvarchar)+'-'+cast(SEGMENT1 as nvarchar) as uniqInv from tbl_ap_invoices_all_sid_amount group by cast(INVOICE_NUM as nvarchar)+'-'+cast(SEGMENT1 as nvarchar)) as tbl_ap_invoices_all_sid_amount
		";
