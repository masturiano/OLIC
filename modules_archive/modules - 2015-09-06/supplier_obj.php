...
class supplierObj extends commonObj {
	...
	function viewSupplier() {
		...
		select asnum,asname
		from tbl_supplier
		left join tbl_ap_suppliers ON tbl_supplier.asnum = tbl_ap_suppliers.SEGMENT1
		where 
		--Filtering
    ...
    function viewDataPj($supnum) {
        ...
        $sql="
            ...
            '00'+cast(INVADIx1.ADINUM as varchar) as ADINUM, --Line17
    ...
    function viewDataPc($supnum) {
        ...
        $sql="
            ...
            cast(TBLSTR.STCOMP as varchar) as STCOMP, --Line15
            cast(TBLSTR.STSHRT as varchar) as STSHRT, --Line16
            '0'+cast(INVADIx1.ADINUM as varchar) as ADINUM, --Line17
            '' as CODE_BUSINESS, --Line18
            '' as CODE_DEPARTMENT, --Line19
            '' as CODE_SECTION, --Line20
            '' as CODE_ACCOUNT, --Line21
