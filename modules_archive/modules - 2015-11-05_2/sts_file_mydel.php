...
switch($_POST['action']){
	...
	case "mmsDataRemvSpace":
		$stsFileObj->mmsDataRemvSpace();
	exit();
	break;	
	
	case "oracleData":
		$stsFileObj->oracleData();
	exit();
	
	case "remvLoadedInv":
		$stsFileObj->remvLoadedInv();
	exit();
	break;	
	
	case "updFileName":
		$stsFileObj->updFileName();
	exit();
	break;	
	
	case "createTxtFile":
	
		$arrFileName = $stsFileObj->viewFileName();
        ...
        <body>
            ...
            <center>
            	<div id="activity_pane" style="height: 100vh;">
                    ...
                    <table border="0">
                    	<th colspan="2">
                        	<h3 align="center"><font style="font-family:Lucida Handwriting"> 401 - STS (Textfiles) </font></h3>
                        </th>
                        <tr>
                            <td colspan="2">
                                <center>
