...
class a01FileObj extends commonObj {
	...
	function updFileName() {
        ...
        /*
		$sql="
		update tbl_a01_invoice set filename = 'PG{$curDate}_{$curTime}.A01' where col008 in ('004','006')
		update tbl_a01_invoice set filename = 'PJ{$curDate}_{$curTime}.A01' where col008 = '005'
		update tbl_a01_invoice set filename = 'PC{$curDate}_{$curTime}.A01' where col008 = '010'
		";
        */
