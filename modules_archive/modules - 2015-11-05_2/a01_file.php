...
switch($_POST['action']){
	...
	case "a01Data":
        ...
        if($_POST['orgId'] == '87'){
            $directory="C:/wamp/www/OLIC/imported_file/a01/a01_pj_data/";  
            $arch_directory="C:/wamp/www/OLIC/imported_file/h01/h01_pj_archive/"; 
            $orgName = "PJ";   
        }else if($_POST['orgId'] == '85'){
            $directory="C:/wamp/www/OLIC/imported_file/a01/a01_pg_data/";  
            $arch_directory="C:/wamp/www/OLIC/imported_file/a01/a01_pg_archive/";  
            $orgName = "PG";
        }else if($_POST['orgId'] == '133'){
            $directory="C:/wamp/www/OLIC/imported_file/a01/a01_sbc_data/";  
            $arch_directory="C:/wamp/www/OLIC/imported_file/a01/a01_sbc_archive/";  
            $orgName = "PC";
        }else if($_POST['orgId'] == '153'){
            $directory="C:/wamp/www/OLIC/imported_file/a01/a01_di_data/";  
            $arch_directory="C:/wamp/www/OLIC/imported_file/a01/a01_di_archive/";
            $orgName = "DI";  
        }else if($_POST['orgId'] == '113'){
            $directory="C:/wamp/www/OLIC/imported_file/a01/a01_fl_data/";  
            $arch_directory="C:/wamp/www/OLIC/imported_file/a01/a01_fl_archive/";
            $orgName = "FL";  
        }else if($_POST['orgId'] == '89'){
            $directory="C:/wamp/www/OLIC/imported_file/a01/a01_dc_data/";  
            $arch_directory="C:/wamp/www/OLIC/imported_file/a01/a01_dc_archive/";
            $orgName = "DC";  
        }else if($_POST['orgId'] == '91'){
            $directory="C:/wamp/www/OLIC/imported_file/a01/a01_ds_data/";  
            $arch_directory="C:/wamp/www/OLIC/imported_file/a01/a01_ds_archive/";
            $orgName = "DS";  
        }else{
            $directory="";  
            $arch_directory="";
			...
			if ($checkEmpty == "Empty"){
                             ...
                             if($orgName == $fileType){
							    ...
							    if (($handle = fopen($csv_file, "r")) !== FALSE) {
								    ...
								    while (($data = fgetcsv($handle, 10000000, "|")) !== FALSE) {
									    ...
									    $a01FileObj->a01Data($col1,$col2,$col3,$col4,$col5,$col6,$col7,$col8,$col9,$col10,$col11,$col12,$col13,$col14,$col15,$col16,$col17,$col18);
								    }	
								    if($loaded = $a01FileObj->displayLoadedRec()){
									    echo "
				...
				foreach(glob($directory.'*.A01*') as $v){
					unlink($v);
				}
				foreach(glob($directory.'*.A01*') as $v){
					unlink($v);
...
$arrOrgId = array('0'=>"Select Company",'87'=>"Junior",'85'=>"PPCI",'133'=>"Subic",'153'=>"DCI",'113'=>"FLS",'89'=>"DFC",'91'=>"DFS");
?>
        ...
        <script type="text/javascript">
			function process()
			{
				...
				({
					url: 'a01_file.php',
					type: 'POST',
					data: 'action=a01Data&orgId='+orgId,
					beforeSend: function()
					{
            ...
            <div id="activity_pane" align="center">
                ...
                <table border="0">
                    ...
                    <tr>
                        ...
                        <td><? $a01FileObj->DropDownMenu($arrOrgId,'cmbOrgId','','class="selectBox"'); ?></td>
                    </tr>
                    <tr>
                        <td colspan="3">
                            <center>
