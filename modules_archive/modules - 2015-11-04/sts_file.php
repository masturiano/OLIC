...
switch($_POST['action']){
	...
	case "olicData":
         ...
         if($_POST['orgId'] == '87'){
            $directory="C:/wamp/www/OLIC/imported_file/sts/sts_pj_data/";  
            $arch_directory="C:/wamp/www/OLIC/imported_file/sts/sts_pj_archive/"; 
            $orgName = "PJ";   
        }else if($_POST['orgId'] == '85'){
            $directory="C:/wamp/www/OLIC/imported_file/sts/sts_pg_data/";  
            $arch_directory="C:/wamp/www/OLIC/imported_file/sts/sts_pg_archive/";  
            $orgName = "PG";
        }else if($_POST['orgId'] == '133'){
            $directory="C:/wamp/www/OLIC/imported_file/sts/sts_sbc_data/";  
            $arch_directory="C:/wamp/www/OLIC/imported_file/sts/sts_sbc_archive/";  
            $orgName = "PC";
        }else if($_POST['orgId'] == '153'){
            $directory="C:/wamp/www/OLIC/imported_file/sts/sts_di_data/";  
            $arch_directory="C:/wamp/www/OLIC/imported_file/sts/sts_di_archive/";
            $orgName = "DI";  
        }else if($_POST['orgId'] == '113'){
            $directory="C:/wamp/www/OLIC/imported_file/sts/sts_fl_data/";  
            $arch_directory="C:/wamp/www/OLIC/imported_file/sts/sts_fl_archive/";
            $orgName = "FL";  
        }else if($_POST['orgId'] == '89'){
            $directory="C:/wamp/www/OLIC/imported_file/sts/sts_dfc_data/";  
            $arch_directory="C:/wamp/www/OLIC/imported_file/sts/sts_dfc_archive/";
            $orgName = "DC";  
        }else if($_POST['orgId'] == '91'){
            $directory="C:/wamp/www/OLIC/imported_file/sts/sts_dfs_data/";  
            $arch_directory="C:/wamp/www/OLIC/imported_file/sts/sts_dfs_archive/";
            $orgName = "DS";  
        }else{
            $directory="";  
            $arch_directory="";
			...
			if ($checkEmpty == "Empty"){
				...
				foreach(glob($directory.'*.401*') as $v){
					unlink($v);
				}
				foreach(glob($directory.'*.401*') as $v){
					unlink($v);
...
$arrOrgId = array('0'=>"Select Company",'87'=>"Junior",'85'=>"PPCI",'133'=>"Subic",'153'=>"DCI",'113'=>"FLS",'89'=>"Dutyfree Clark",'91'=>"Dutyfree Subic");
?>
