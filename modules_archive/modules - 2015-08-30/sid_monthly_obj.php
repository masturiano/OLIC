...
class olicDailyObj extends commonObj {
	...
	function viewOlicInv($orgId) {
		...
		$sql="
		select Col001,Col004,Col013 as Col013 from tbl_sid_invoice_{$orgId} group by Col001,Col004,Col013
		";
	...
	function updFileName($orgId) {
        ...
        $sqlPjDup="
        update tbl_sid_invoice_{$orgId} set Col040 = 'PJ{$curDate}_duplic.001' where cast(Col001 as nvarchar)+'-'+cast(Col004 as nvarchar) in (
        select cast(Col001 as nvarchar)+'-'+cast(Col004 as nvarchar) as a from (
        select count(cast(Col001 as nvarchar)+'-'+cast(Col005 as nvarchar)) as duplicate,Col001,Col004 from tbl_sid_invoice_{$orgId}
        where Col011 = 'SID' 
        ...
        $sqlPgDup="
        update tbl_sid_invoice_{$orgId} set Col040 = 'PG{$curDate}_duplic.001' where cast(Col001 as nvarchar)+'-'+cast(Col004 as nvarchar) in (
        select cast(Col001 as nvarchar)+'-'+cast(Col004 as nvarchar) as a from (
        select count(cast(Col001 as nvarchar)+'-'+cast(Col005 as nvarchar)) as duplicate,Col001,Col004 from tbl_sid_invoice_{$orgId}
        where Col011 = 'SID' 
        group by Col001,Col004) as doubleInvoice
        ...
        $sqlPcDup="
        update tbl_sid_invoice_{$orgId} set Col040 = 'PC{$curDate}_duplic.001' where cast(Col001 as nvarchar)+'-'+cast(Col004 as nvarchar) in (
        select cast(Col001 as nvarchar)+'-'+cast(Col004 as nvarchar) as a from (
        select count(cast(Col001 as nvarchar)+'-'+cast(Col005 as nvarchar)) as duplicate,Col001,Col004 from tbl_sid_invoice_{$orgId}
        where Col011 = 'SID' 
        group by Col001,Col004) as doubleInvoice
        ...
        $sqlDiDup="
        update tbl_sid_invoice_{$orgId} set Col040 = 'DI{$curDate}_duplic.001' where cast(Col001 as nvarchar)+'-'+cast(Col004 as nvarchar) in (
        select cast(Col001 as nvarchar)+'-'+cast(Col004 as nvarchar) as a from (
        select count(cast(Col001 as nvarchar)+'-'+cast(Col005 as nvarchar)) as duplicate,Col001,Col004 from tbl_sid_invoice_{$orgId}
        where Col011 = 'SID' 
        group by Col001,Col004) as doubleInvoice
        ...
        $sqlFlDup="
        update tbl_sid_invoice_{$orgId} set Col040 = 'FL{$curDate}_duplic.001' where cast(Col001 as nvarchar)+'-'+cast(Col004 as nvarchar) in (
        select cast(Col001 as nvarchar)+'-'+cast(Col004 as nvarchar) as a from (
        select count(cast(Col001 as nvarchar)+'-'+cast(Col005 as nvarchar)) as duplicate,Col001,Col004 from tbl_sid_invoice_{$orgId}
        where Col011 = 'SID' 
        group by Col001,Col004) as doubleInvoice
