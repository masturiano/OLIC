...
switch($_POST['action']){
	...
	case "olicData":
         ...
         if($_POST['orgId'] == '87'){
            $directory="C:/wamp/www/OLIC/imported_file/rfp/rfp_pj_data/";  
            $arch_directory="C:/wamp/www/OLIC/imported_file/rfp/rfp_pj_archive/"; 
            $orgName = "PJ";   
        }else if($_POST['orgId'] == '85'){
            $directory="C:/wamp/www/OLIC/imported_file/rfp/rfp_pg_data/";  
            $arch_directory="C:/wamp/www/OLIC/imported_file/rfp/rfp_pg_archive/";  
            $orgName = "PG";
        }else if($_POST['orgId'] == '133'){
            $directory="C:/wamp/www/OLIC/imported_file/rfp/rfp_sbc_data/";  
            $arch_directory="C:/wamp/www/OLIC/imported_file/rfp/rfp_sbc_archive/";  
            $orgName = "PC";
        }else if($_POST['orgId'] == '153'){
            $directory="C:/wamp/www/OLIC/imported_file/rfp/rfp_di_data/";  
            $arch_directory="C:/wamp/www/OLIC/imported_file/rfp/rfp_di_archive/";
            $orgName = "DI";  
        }else if($_POST['orgId'] == '113'){
            $directory="C:/wamp/www/OLIC/imported_file/rfp/rfp_fl_data/";  
            $arch_directory="C:/wamp/www/OLIC/imported_file/rfp/rfp_fl_archive/";
            $orgName = "FL";  
        }else{
            $directory="";  
            $arch_directory="";
			...
			if ($checkEmpty == "Empty"){
				...
				foreach(glob($directory.'*.G01*') as $v){
					unlink($v);
				}
				foreach(glob($directory.'*.G01*') as $v){
					unlink($v);
    ...
    case "updBl":
        $olicDailyObj->updBl($_POST['orgId']);
    exit();
    break;    
        ...
        <script type="text/javascript">
            ...
            function process5(orgId)
            {
                ...
                ({
                    url: 'rfp_file.php',
                    type: 'POST',
                    data: 'action=updBl&orgId='+orgId,
                    success: function(data1){
                        $().toastmessage('showToast', {
                            text: 'Updating business line success!',
                            sticky: false,
                            position: 'middle-center',
                            type: 'success',
                            closeText: '',
