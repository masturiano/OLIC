...
switch($_POST['action']){
	...
	case "mmsDataRemvSpace":
		$rfpFileObj->mmsDataRemvSpace();
	exit();
	break;	
	
	case "oracleData":
		$rfpFileObj->oracleData();
	exit();
	
	case "remvLoadedInv":
		$rfpFileObj->remvLoadedInv();
	exit();
	break;	
	
	case "updFileName":
		$rfpFileObj->updFileName();
	exit();
	break;	
	
	case "createTxtFile":
	
		$arrFileName = $rfpFileObj->viewFileName();
        ...
        <body>
            ...
            <center>
            	<div id="activity_pane" style="height: 100vh;">
                    ...
                    <table border="0">
                    	<th colspan="2">
                        	<h3 align="center"><font style="font-family:Lucida Handwriting"> G01 - RFP (Textfiles) </font></h3>
                        </th>
                        <tr>
                            <td colspan="2">
                                <center>
