...
class olicDailyObj extends commonObj {
    ...
    function remvLoadedInvFirst() {
        ...
        in (select cast(INVOICE_NUM as nvarchar)+'-'+cast(SEGMENT1 as nvarchar)+'='+cast(INVOICE_AMOUNT as nvarchar) from tbl_ap_invoices_all_rtv_amount)
        ";
        $this->execQry($sql);
    }
	...
	function viewOlicInv() {
		...
		$sql="
		select Col001,Col004,Col006 as Col006 from tbl_rtv_invoice group by Col001,Col004,Col006
		";
	...
	function oracleData($orgId) {
		...
		$truncTable = "truncate table tbl_ap_invoices_all_rtv_amount";
		
		if($this->execQry($truncTable)){
		
			foreach($arrOlicInv as $valOlicInv){
				$sql="
                insert into tbl_ap_invoices_all_rtv_amount (INVOICE_NUM,SEGMENT1,INVOICE_AMOUNT)
	...
	function updFileNameDuplicate($orgId) {
        ...
        $sqlPj="
        update tbl_rtv_invoice set Col040 = 'PJ{$curDate}_duplicate.901' where Col011 = 'RTV'
        and Col005 in 
        (
        ...
        $sqlPg="
        update tbl_rtv_invoice set Col040 = 'PG{$curDate}_duplicate.901' where Col011 = 'RTV' 
        and Col005 in 
        (
        ...
        $sqlPc="
        update tbl_rtv_invoice set Col040 = 'PC{$curDate}_duplicate.901' where Col011 = 'RTV'
        and Col005 in 
        (
        ...
        $sqlDi="
        update tbl_rtv_invoice set Col040 = 'DI{$curDate}_duplicate.901' where Col011 = 'RTV'
        and Col005 in 
        (
        ...
        $sqlFl="
        update tbl_rtv_invoice set Col040 = 'FL{$curDate}_duplicate.901' where Col011 = 'RTV'
        and Col005 in 
        (
    ...
    function updFileNameCancelled($orgId) {
        ...
        $sqlPj="
        update tbl_rtv_invoice set Col040 = 'PJ{$curDate}_cancelled.901' where Col011 = 'RTV'
        and Col005 in 
        (
            select STSHRT from sql_mmpgtlib.dbo.tblstr where STCOMP = 700
            and STRNAM NOT LIKE 'X%'
        ...
        and cast(Col001 as nvarchar)+'-'+cast(Col004 as nvarchar) in (
            ...
            left join tbl_ap_invoices_all_rtv_amount b
            on 
        ...
        $sqlPg="
        update tbl_rtv_invoice set Col040 = 'PG{$curDate}_cancelled.901' where Col011 = 'RTV' 
        and Col005 in 
        (
            select STSHRT from sql_mmpgtlib.dbo.tblstr 
            LEFT JOIN
        ...
        $sqlPc="
        update tbl_rtv_invoice set Col040 = 'PC{$curDate}_cancelled.901' where Col011 = 'RTV'
        and Col005 in 
        (
            select STSHRT from sql_mmpgtlib.dbo.tblstr where STCOMP = 302
            and STRNAM NOT LIKE 'X%'
        ...
        $sqlDi="
        update tbl_rtv_invoice set Col040 = 'DI{$curDate}_cancelled.901' where Col011 = 'RTV'
        and Col005 in 
        (
            select STSHRT from sql_mmneslib.dbo.tblstr where STCOMP = 810
            and STRNUM < 900
        ...
        $sqlFl="
        update tbl_rtv_invoice set Col040 = 'FL{$curDate}_cancelled.901' where Col011 = 'RTV'
        and Col005 in 
        (
            select STSHRT from sql_mmneslib.dbo.tblstr where STCOMP = 811
            and STRNUM < 900
