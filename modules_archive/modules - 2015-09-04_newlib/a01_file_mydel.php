...
switch($_POST['action']){
	...
	case "a01Data":
		...
		$directory="C:/wamp/www/OLIC/a01_data/";
			$arch_directory="C:/wamp/www/OLIC/a01_archive/";
			...
			if ($checkEmpty == "Empty"){
				...
				$dir = 'C:/wamp/www/OLIC/a01_data/';
				foreach(glob($dir.'*.A01*') as $v){
					unlink($v);
				}
				foreach(glob($dir.'*.A01*') as $v){
					unlink($v);
        ...
        <body>
            ...
            <center>
            	<div id="activity_pane" style="height: 100vh;">
                    ...
                    <table border="0">
                    	<th colspan="2">
							<h3 align="center"><font style="font-family:Lucida Handwriting"> A01 (Textfiles) </font></h3>
                        </th>
                        <tr>
                            <td colspan="2">
                                <center>
