...
include("sid_date_range_text_obj.php");
...
switch($_POST['action']){
    ...
    case "updFileName":
        $olicDateRangeObj->updFileName($_POST['orgId']);
    exit();
    break;    
        ...
        <script type="text/javascript">
            ...
            function process3(dteProc,dteProc2,orgId)
            {
                ...
                ({
                    url: 'sid_date_range_text.php',
                    type: 'POST',
                    data: 'action=updFileName&getTxtDateFrom='+dteProc+'&getTxtDateTo='+dteProc2+'&orgId='+orgId,
                    success: function(data1){
                        $().toastmessage('showToast', {
                    ...
                    <tr>
                        <td colspan="3" align="center">  
                            <font style="font-family:Lucida Handwriting; font-size: 15px;"> 
                                <b>001 - SID File Date Range Text</b>
                            </font>   
                        </td>
                    </tr>
                    <tr>
