...
class olicDateRangeObj extends commonObj {
	...
	function updFileNameDuplicate($orgId) {
        ...
        $sqlPj="
        update tbl_sid_invoice set Col040 = 'PJ{$curDate}_duplicate.001' where Col011 = 'SID'
        and Col005 in 
        (
        ...
        $sqlPg="
        update tbl_sid_invoice set Col040 = 'PG{$curDate}_duplicate.001' where Col011 = 'SID' 
        and Col005 in 
        (
        ...
        $sqlPc="
        update tbl_sid_invoice set Col040 = 'PC{$curDate}_duplicate.001' where Col011 = 'SID'
        and Col005 in 
        (
        ...
        $sqlDi="
        update tbl_sid_invoice set Col040 = 'DI{$curDate}_duplicate.001' where Col011 = 'SID'
        and Col005 in 
        (
        ...
        $sqlFl="
        update tbl_sid_invoice set Col040 = 'FL{$curDate}_duplicate.001' where Col011 = 'SID'
        and Col005 in 
        (
    ...
    function updFileNameCancelled($orgId) {
        ...
        $sqlPj="
        update tbl_sid_invoice set Col040 = 'PJ{$curDate}_cancelled.001' where Col011 = 'SID'
        and Col005 in 
        (
            select STSHRT from sql_mmpgtlib.dbo.tblstr where STCOMP = 700
            and STRNAM NOT LIKE 'X%'
        ...
        and cast(Col001 as nvarchar)+'-'+cast(Col004 as nvarchar) in (
            select cast(a.Col001 as nvarchar)+'-'+cast(a.Col004 as nvarchar) from tbl_sid_invoice a
            left join tbl_ap_invoices_all_sid_amount b
            on 
        ...
        $sqlPg="
        update tbl_sid_invoice set Col040 = 'PG{$curDate}_cancelled.001' where Col011 = 'SID' 
        and Col005 in 
        (
            select STSHRT from sql_mmpgtlib.dbo.tblstr 
            LEFT JOIN
        ...
        $sqlPc="
        update tbl_sid_invoice set Col040 = 'PC{$curDate}_cancelled.001' where Col011 = 'SID'
        and Col005 in 
        (
            select STSHRT from sql_mmpgtlib.dbo.tblstr where STCOMP = 302
            and STRNAM NOT LIKE 'X%'
        ...
        $sqlDi="
        update tbl_sid_invoice set Col040 = 'DI{$curDate}_cancelled.001' where Col011 = 'SID'
        and Col005 in 
        (
            select STSHRT from sql_mmneslib.dbo.tblstr where STCOMP = 810
            and STRNUM < 900
        ...
        $sqlFl="
        update tbl_sid_invoice set Col040 = 'FL{$curDate}_cancelled.001' where Col011 = 'SID'
        and Col005 in 
        (
            select STSHRT from sql_mmneslib.dbo.tblstr where STCOMP = 811
            and STRNUM < 900
