...
switch($_GET['action']){
	...
	case "createTextFile":
        ...
        $arrData = $supplierObj->viewData($_GET['storeShort']);
...
<html>
	<head>
        ...
        <script type="text/javascript">
			function process()
			{
				var strShort = $("#txtStoreShort").val();

                if(strShort == ''){
                    $().toastmessage('showToast', {
                        text: 'Please search store!',
                        sticky: true,
				...
				$.ajax
                ({
                    url: 'supplier_site.php',
                    type: 'GET',
                    data: 'action=createTextFile&storeShort='+strShort,
                    beforeSend: function()
                    {
                    ...
                    success: function(data1){
                        ...
                        $().toastmessage('showToast', {
                            text: 'Textfile created for store short '+strShort,
                            sticky: true,
                            position: 'middle-center',
                            type: 'success',
                            closeText: '',
            ...
            $(function(){
                $("#txtStore").autocomplete({
                    source: "supplier_site.php?action=searchStore",
                    minLength: 1,
