...
class conFileObj extends commonObj {

	function clearTblConInvoice(){
		$sql = "
	...
	function concessData($col1,$col2,$col3,$col4,$col5,$col6,$col7,$col8,$col9,$col10,$col11,$col12,$col13,$col14,$col15,$col16,$col17,$col18,$col19,$col20,$col21,$col22,$col23,$col24,$col25,$col26,$col27,$col28,$col29,$col30,$col31,$col32,$col33,$col34,$col35,$col36,$col37,$col38,$col39,$col40) {
	...
	function viewConInv() {
		...
		$sql="
		select distinct(Col001) as Col001 from tbl_con_invoice
		";
	...
	function oracleData() {
		...
		if($this->execQry($truncTable)){
			...
			foreach($arrConInv as $valConInv){
				$sql="
				insert into tbl_ap_invoices_all_con_amount (INVOICE_NUM,SEGMENT1)
	...
	function remvLoadedInv() {
		...
		in (select cast(INVOICE_NUM as nvarchar)+'-'+cast(SEGMENT1 as nvarchar) from tbl_ap_invoices_all_con_amount)
		";
		$this->execQry($sql);
	}
	...
	function updFileName() {
        ...
        /*
		$sql="
		update tbl_con_invoice set Col040 = 'PJ{$curDate}_{$curTime}.601' where Col011 = 'CON' and Col040 like 'PJ%'
		update tbl_con_invoice set Col040 = 'PG{$curDate}_{$curTime}.601' where Col011 = 'CON' and Col040 like 'PG%'
		update tbl_con_invoice set Col040 = 'PC{$curDate}_{$curTime}.601' where Col011 = 'CON' and Col040 like 'PC%'
		";
        */
