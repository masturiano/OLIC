...
class olicDailyObj extends commonObj {
    ...
    function updBl($orgId) {
        ...
        foreach($storeShortPj as $valStoreShortPj){
            ...
            (select CONCAT('00',INVADIx1.ADINUM) from openquery(pgjda, 'select * from mmpgtlib.TBLSTR where STSHRT = ''{$valStoreShortPj['shortName']}''') TBLSTR 
            LEFT JOIN
            OPENQUERY(pgjda, 'select * from mmpgtlib.INVADIx1') INVADIx1
            ON  TBLSTR.STRNUM = INVADIx1.STRNUM)
            ";       
        ...
        foreach($storeShortPg as $valStoreShortPg){
            $sqlPg="
            update tbl_rfp_invoice SET Col017 =
            (select CONCAT('00',INVADIx1.ADINUM) from openquery(pgjda, 'select * from mmpgtlib.TBLSTR where STSHRT = ''{$valStoreShortPg['shortName']}''') TBLSTR 
            LEFT JOIN
            OPENQUERY(pgjda, 'select * from mmpgtlib.INVADIx1') INVADIx1
            ON  TBLSTR.STRNUM = INVADIx1.STRNUM)
            ";   
        ...
        foreach($storeShortPc as $valStoreShortPc){
            $sqlPc="
            update tbl_rfp_invoice SET Col017 =  
            (select CONCAT('0',INVADIx1.ADINUM) from openquery(pgjda, 'select * from mmpgtlib.TBLSTR where STSHRT = ''{$valStoreShortPc['shortName']}''') TBLSTR 
            LEFT JOIN
            OPENQUERY(pgjda, 'select * from mmpgtlib.INVADIx1') INVADIx1
            ON  TBLSTR.STRNUM = INVADIx1.STRNUM)
            ";
        ...
        foreach($storeShortDi as $valStoreShortDi){
            $sqlDi="
            update tbl_rfp_invoice SET Col017 = 
            (select CONCAT('00',INVADIx1.ADINUM) from openquery(pgjda, 'select * from mmpgtlib.TBLSTR where STSHRT = ''{$valStoreShortDi['shortName']}''') TBLSTR 
            LEFT JOIN
            OPENQUERY(pgjda, 'select * from mmpgtlib.INVADIx1') INVADIx1
            ON  TBLSTR.STRNUM = INVADIx1.STRNUM)
            ";
        ...
        foreach($storeShortFl as $valStoreShortFl){
            $sqlFl="
            update tbl_rfp_invoice SET Col017 = 
            (select CONCAT('00',INVADIx1.ADINUM) from openquery(pgjda, 'select * from mmpgtlib.TBLSTR where STSHRT = ''{$valStoreShortFl['shortName']}''') TBLSTR 
            LEFT JOIN
            OPENQUERY(pgjda, 'select * from mmpgtlib.INVADIx1') INVADIx1
            ON  TBLSTR.STRNUM = INVADIx1.STRNUM)
            ";     
