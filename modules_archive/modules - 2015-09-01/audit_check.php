...
include("audit_check_obj.php");

$oracleDataObj = new oracleDataObj();
...
switch($_POST['action']){
	...
	case "stsData":
		...
		$directory="C:/wamp/www/OLIC/sts_data/";
			...
			if ($checkEmpty == "Empty"){
				...
				$oracleDataObj->clearTblStsInvoice();
						...
						if($file_ext == "401"){
							...
							if (($handle = fopen($csv_file, "r")) !== FALSE) {
								...
								while (($data = fgetcsv($handle, 10000000, "|")) !== FALSE) {
									...
									$oracleDataObj->oracleData($col1,$col2,$col3,$col4,$col5,$col6,$col7,$col8,$col9,$col10,$col11,$col12,$col13,$col14,$col15,$col16,$col17,$col18,$col19,$col20,$col21,$col22,$col23,$col24,$col25,$col26,$col27,$col28,$col29,$col30,$col31,$col32,$col33,$col34,$col35,$col36,$col37,$col38,$col39,$col40);
								}	
								if($loaded = $oracleDataObj->displayLoadedRec()){
									echo "
	...
	case "mmsDataRemvSpace":
		$oracleDataObj->mmsDataRemvSpace();
	exit();
	break;	
	
	case "oracleData":
		$oracleDataObj->oracleData();
	exit();
	
	case "remvLoadedInv":
		$oracleDataObj->remvLoadedInv();
	exit();
	break;	
	
	case "updFileName":
		$oracleDataObj->updFileName();
	exit();
	break;	
	
	case "createTxtFile":
	
		$arrFileName = $oracleDataObj->viewFileName();
		
		foreach($arrFileName as $valFileName){
			
			$fileName = $valFileName['Col040'];
			
			$arrFileCont = $oracleDataObj->viewSts($fileName);
        ...
        <body>
            ...
            <center>
            	<div id="activity_pane" style="height: 100vh;">
                    ...
                    <table border="0">
                    	<th colspan="2">
                        	<h3 align="center"><font style="font-family:Lucida Handwriting"> Oracle Data Only</font></h3>
                        </th>
                        <tr>
                            <td colspan="2">
                                <center>
                                    <br />
                                    <button class="btn btn-success" onClick="process3();" value="Analyze">  Process  </button>
                                </center>
                            </td>
                        </tr>
                    </table>
