...
include("efd_file_obj.php");

$efdFileObj = new efdFileObj();

switch($_POST['action']){
	
	case "efdData":
		
		$directory="C:/wamp/www/OLIC/efd_data/";
			$arch_directory="C:/wamp/www/OLIC/efd_archive/";
						...
						if($file_ext == "401"){
							...
							if (($handle = fopen($csv_file, "r")) !== FALSE) {
								...
								while (($data = fgetcsv($handle, 10000000, "|")) !== FALSE) {
									...
									$efdFileObj->efdData($col1,$col2,$col3,$col4,$col5,$col6,$col7,$col8,$col9,$col10,$col11,$col12,$col13,$col14,$col15,$col16,$col17,$col18,$col19,$col20,$col21,$col22,$col23,$col24,$col25,$col26,$col27,$col28,$col29,$col30,$col31,$col32,$col33,$col34,$col35,$col36,$col37,$col38,$col39,$col40);
								}	
								if($loaded = $efdFileObj->displayLoadedRec()){
									echo "
	...
	case "mmsDataRemvSpace":
		$efdFileObj->mmsDataRemvSpace();
	exit();
	break;	
	
	case "oracleData":
		$efdFileObj->oracleData();
	exit();
	
	case "remvLoadedInv":
		$efdFileObj->remvLoadedInv();
	exit();
	break;	
	
	case "updFileName":
		$efdFileObj->updFileName();
	exit();
	break;	
	
	case "createTxtFile":
	
		$arrFileName = $efdFileObj->viewFileName();
		
		foreach($arrFileName as $valFileName){
			
			$fileName = $valFileName['Col040'];
			
			$arrFileCont = $efdFileObj->viewEfd($fileName);
				...
				({
					...
					success: function(data1){
						if(data1 == 0){
							...
							$().toastmessage('showToast', {
								text: 'Copy 401 (EFD) data success!',
								sticky: true,
								position: 'middle-center',
								type: 'success',
								closeText: '',
        ...
        <body>
            ...
            <center>
            	<div id="activity_pane" style="height: 100vh;">
                    ...
                    <table border="0">
                    	<th colspan="2">
                        	<h3 align="center"><font style="font-family:Lucida Handwriting"> 401 - EFD (Textfiles) </font></h3>
                        </th>
                        <tr>
                            <td colspan="2">
                                <center>
