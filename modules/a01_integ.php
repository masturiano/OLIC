...
switch($_POST['action']){
	...
	case "removeDoubleCreate":
		
		$unloadedInv = $a01FileObj->removeDoubleCreate();
		echo $unloadedInv;
		
	exit();
	break;	
	case "getLoadedInvoice":
		
		$unloadedInv = $a01FileObj->getLoadedInvoice();
		echo $unloadedInv;
		
	exit();
	break;	
	case "removeLoadedInvoice":
		
		$unloadedInv = $a01FileObj->removeLoadedInvoice();
		echo $unloadedInv;
        ...
        <script type="text/javascript">
			...
			function removeDoubleCreate()
			{
				...
				({
					url: 'a01_integ.php',
					type: 'POST',
					data: 'action=removeDoubleCreate',
					beforeSend: function()
					{
						jQuery('#activity_pane').showLoading();
                        $('#process').html('Processing');
			...
			function removeLoadedInvoice(){
				
				$.ajax
				({
					url: 'a01_integ.php',
					type: 'POST',
					data: 'action=removeLoadedInvoice',
					beforeSend: function()
					{
						jQuery('#activity_pane').showLoading();
                        $('#process').html('Processing');
                ...
                <table border="0">
                    ...
                    <tr>
                        <td colspan="3">
                            <center>
                                <br />
                                <button class="btn btn-success" id="rmvDblCrt" onClick="removeDoubleCreate();" class="btn" value="Analyze"> Remove Double Create </button>
                            </center>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="3">
                            <center>
                                <br />
                                <button class="btn btn-success" id="rmvDblCrt" onClick="getLoadedInvoice();" class="btn" value="Analyze"> Remove Loaded </button>
                            </center>
                        </td>
                    </tr>
                </table>
