...
switch($_POST['action']){
	...
	case "olicData":
         ...
         if($_POST['orgId'] == '87'){
            $directory="C:/wamp/www/OLIC/imported_file/efd/efd_pj_data/";  
            $arch_directory="C:/wamp/www/OLIC/imported_file/efd/efd_pj_archive/";   
            $orgName = "PJ";   
        }else if($_POST['orgId'] == '85'){
            $directory="C:/wamp/www/OLIC/imported_file/efd/efd_pg_data/";  
            $arch_directory="C:/wamp/www/OLIC/imported_file/efd/efd_pg_archive/"; 
            $orgName = "PG";  
        }else if($_POST['orgId'] == '133'){
            $directory="C:/wamp/www/OLIC/imported_file/efd/efd_sbc_data/";  
            $arch_directory="C:/wamp/www/OLIC/imported_file/efd/efd_sbc_archive/"; 
            $orgName = "PC";  
        }else if($_POST['orgId'] == '153'){
            $directory="C:/wamp/www/OLIC/imported_file/efd/efd_di_data/";  
            $arch_directory="C:/wamp/www/OLIC/imported_file/efd/efd_di_archive/"; 
            $orgName = "DI";  
        }else if($_POST['orgId'] == '113'){
            $directory="C:/wamp/www/OLIC/imported_file/efd/efd_fl_data/";  
            $arch_directory="C:/wamp/www/OLIC/imported_file/efd/efd_fl_archive/"; 
            $orgName = "FL";  
        }else{
            $directory="";  
            $arch_directory="";
                ...
                <table border="0">
                    ...
                    <tr>
                        <td colspan="3">
                            <center>
                                <br />
                                <button class="btn btn-success" id="process" onClick="process6();" class="btn" value="Analyze"> Process </button>
                            </center>
                        </td>
                    </tr>
                </table>
