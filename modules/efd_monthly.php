        ...
        <script type="text/javascript">
			function process()
			{
				...
				({
					url: 'efd_monthly.php',
					type: 'POST',
					data: 'action=mmsData&getTxtMonYr='+monYr+'&orgId='+orgId,
					beforeSend: function()
					{
					...
					success: function(data1){
						...
						process2(monYr,orgId);
					}
				});	
			}
			
			function process2(monYr,orgId)
			{
				$.ajax
				({
					url: 'efd_monthly.php',
					type: 'POST',
					data: 'action=mmsDataRemvSpace&getTxtMonYr='+monYr+'&orgId='+orgId,
					success: function(data1){
						$().toastmessage('showToast', {
						...
						process3(monYr,orgId);
					}
				});	
			}
			
			function process3(monYr,orgId)
			{
				$.ajax
				({
					url: 'efd_monthly.php',
					type: 'POST',
					data: 'action=oracleData&getTxtMonYr='+monYr+'&orgId='+orgId,
					success: function(data1){
						$().toastmessage('showToast', {
						...
						process4(monYr,orgId);
					}
				});	
			}
			
			function process4(monYr,orgId)
			{
				$.ajax
				({
					url: 'efd_monthly.php',
					type: 'POST',
					data: 'action=remvLoadedInv&getTxtMonYr='+monYr+'&orgId='+orgId,
					success: function(data1){
						$().toastmessage('showToast', {
						...
						process5(monYr,orgId);
					}
				});	
			}
			
			function process5(monYr,orgId)
			{
				$.ajax
				({
					url: 'efd_monthly.php',
					type: 'POST',
					data: 'action=updFileName&getTxtMonYr='+monYr+'&orgId='+orgId,
					success: function(data1){
						$().toastmessage('showToast', {
						...
						process6(monYr,orgId);
					}
				});	
			}
			
			function process6(monYr,orgId)
			{
				$.ajax
				({
					url: 'efd_monthly.php',
					type: 'POST',
					data: 'action=createTxtFile&getTxtMonYr='+monYr+'&orgId='+orgId,
					success: function(data1){
						$().toastmessage('showToast', {
