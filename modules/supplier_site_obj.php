...
class supplierObj extends commonObj {
    ...
    function viewData($strShort) {
        ...
        $sqlPj = "
            select count(*) as count from openquery(pgjda, 'select * from mm760lib.tblstr') where STCOMP = 700
        ...
        $sqlPg = "
            select count(*) as count from openquery(pgjda, 'select * from mm760lib.TBLSTR') TBLSTR 
            LEFT JOIN
        ...
        $sqlPc = "
            select count(*) as count from openquery(pgjda, 'select * from mm760lib.tblstr') where STCOMP = 302
            and STRNAM NOT LIKE 'X%'
            and STRNUM < 900
            and STRNUM <> 805
            and STSHRT <> 'SBCHO' 
        ...
        $sql="
            ...
            '{$header_bl}'+cast(INVADIx1.ADINUM as varchar) as ADINUM, --Line17
