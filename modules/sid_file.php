...
include("sid_file_obj.php");

$olicDailyObj = new olicDailyObj();
//UPDATE:added DFC and DFS -by Harold
...
switch($_POST['action']){
	...
	case "olicData":
         ...
         if($_POST['orgId'] == '87'){
            $directory="C:/wamp/www/OLIC/imported_file/sid/sid_pj_data/";  
            $arch_directory="C:/wamp/www/OLIC/imported_file/sid/sid_pj_archive/";   
            $orgName = "PJ";   
        }else if($_POST['orgId'] == '85'){
            $directory="C:/wamp/www/OLIC/imported_file/sid/sid_pg_data/";  
            $arch_directory="C:/wamp/www/OLIC/imported_file/sid/sid_pg_archive/"; 
            $orgName = "PG";  
        }else if($_POST['orgId'] == '133'){
            $directory="C:/wamp/www/OLIC/imported_file/sid/sid_sbc_data/";  
            $arch_directory="C:/wamp/www/OLIC/imported_file/sid/sid_sbc_archive/"; 
            $orgName = "PC";  
        }else if($_POST['orgId'] == '153'){
            $directory="C:/wamp/www/OLIC/imported_file/sid/sid_di_data/";  
            $arch_directory="C:/wamp/www/OLIC/imported_file/sid/sid_di_archive/"; 
            $orgName = "DI";  
        }else if($_POST['orgId'] == '113'){
            $directory="C:/wamp/www/OLIC/imported_file/sid/sid_fl_data/";  
            $arch_directory="C:/wamp/www/OLIC/imported_file/sid/sid_fl_archive/"; 
            $orgName = "FL";  
        }else if($_POST['orgId'] == '89'){
            $directory="C:/wamp/www/OLIC/imported_file/sid/sid_dfc_data/";  
            $arch_directory="C:/wamp/www/OLIC/imported_file/sid/sid_dfc_archive/"; 
            $orgName = "DC";  
        }else if($_POST['orgId'] == '91'){
            $directory="C:/wamp/www/OLIC/imported_file/sid/sid_dfs_data/";  
            $arch_directory="C:/wamp/www/OLIC/imported_file/sid/sid_dfs_archive/"; 
            $orgName = "DS";  
        }else{
            $directory="";  
            $arch_directory="";
			...
			if ($checkEmpty == "Empty"){
				...
				foreach(glob($directory.'*.001*') as $v){
					unlink($v);
				}
				foreach(glob($directory.'*.001*') as $v){
					unlink($v);
