...
switch($_POST['action']){
	...
	case "mmsData":
		$sidDailyObj->mmsData($_POST['getTxtMonYr']);
	exit();
	break;	
	...
	case "oracleData":
		$sidDailyObj->oracleData($_POST['getTxtMonYr']);
	exit();
        ...
        <body>
            ...
            <center>
            	<div id="activity_pane" style="height: 100vh;">
                    <table border="0">
                    	<th colspan="2">
                        	<h3 align="center"><font style="font-family:Lucida Handwriting"> 001 - SID (Monthly) </font></h3>
                        </th>
                        <tr>
                            <td>
                                MMS Data:
